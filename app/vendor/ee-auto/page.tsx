...
function EEAutoTrackingContent() {
    ...
    const t = (key: string) => {
        const translations: any = {
            zh: {
                ...
                log_deal: '记录交易',
                view_deals: '查看所有交易',
                price_list: 'EE汽车集团价格表',
                total_amount: '总金额',
                submit_sale: '提交销售',
                previous_sales: '历史销售',
                no_prev_sales: '该会员暂无历史销售。',
                sale_logged: '交易已记录！感谢EE Auto。',
            ...
            en: {
                title: 'EE Auto Group Deal Tracking',
    ...
    useEffect(() => {
        const savedLang = localStorage.getItem('eeauto_lang');
                ...
                <div className="header-content">
                    ...
                    <div className="ee-auto-brand">
                        ...
                        <button className="lang-btn" onClick={() => {
                            ...
                            setLang(newLang);
                            localStorage.setItem('eeauto_lang', newLang);
                        }}>
                            {lang === 'zh' ? 'EN' : '中文'}
                        </button>
                    </div>
